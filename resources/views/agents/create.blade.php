            ...
            <div class="space-y-6">
                ...
                <div>
                   ...
                   <select id="role" 
                       ...
                       <option value="agent" {{ old('role') == 'agent' ? 'selected' : '' }}>Agent d'accueil (Dossiers)</option>
                       <option value="agent_biometrie" {{ old('role') == 'agent_biometrie' ? 'selected' : '' }}>Agent Biométrie</option>
                   </select>
                ...
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    function togglePermissions() {
                        if (roleSelect.value === 'agent_biometrie') {
                            ...
                            // Désélectionner toutes les cases pour éviter d'envoyer des permissions inutiles
