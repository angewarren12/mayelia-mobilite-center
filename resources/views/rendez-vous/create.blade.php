        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Créer un Nouveau Rendez-vous</h3>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" id="date_rendez_vous" name="date_rendez_vous" 
                                           value="{{ old('date_rendez_vous') }}" required min="{{ date('Y-m-d', strtotime('+1 day')) }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="tranche_horaire" name="tranche_horaire" 
                                           value="{{ old('tranche_horaire') }}" required
