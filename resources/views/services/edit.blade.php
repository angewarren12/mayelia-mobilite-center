...
@section('subtitle', 'Modifiez les informations du service')
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <select id="duree_rdv" 
                        ...
                        <option value="15" {{ old('duree_rdv', $service->duree_rdv) == '15' ? 'selected' : '' }}>15 minutes</option>
                        <option value="30" {{ old('duree_rdv', $service->duree_rdv) == '30' ? 'selected' : '' }}>30 minutes</option>
                        <option value="45" {{ old('duree_rdv', $service->duree_rdv) == '45' ? 'selected' : '' }}>45 minutes</option>
                        <option value="60" {{ old('duree_rdv', $service->duree_rdv) == '60' ? 'selected' : '' }}>1 heure</option>
                        <option value="90" {{ old('duree_rdv', $service->duree_rdv) == '90' ? 'selected' : '' }}>1h30</option>
                        <option value="120" {{ old('duree_rdv', $service->duree_rdv) == '120' ? 'selected' : '' }}>2 heures</option>
                    </select>
                    @error('duree_rdv')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
